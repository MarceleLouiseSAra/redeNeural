...
O presente projeto implementa uma rede neural artificial, cuja camada oculta variar de tamanho, pode e a treina para resolver o problema da porta lógica XOR.
